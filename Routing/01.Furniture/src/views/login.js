...
export async function loginPage(cntx) {
    cntx.render(loginTemplate(onSubmit));
    ...
    async function onSubmit(ev) {
        ...
        if (email == '' || password == '') {
            return await cntx.render(loginTemplate(onSubmit, 'All fields are required!', email == '', password == ''));
        }
